...
function CountriesStackScreen({ navigation, route, countries, addCountry, addCurrencyDesc }) {
  return (
    <Stack.Navigator
      screenOptions={{
        headerStyle: {
    ...
    >
      <Stack.Screen
        name="Countries"
        children={(props) => (
          <Countries {...props} countries={countries} addCountry={addCountry} addCurrencyDesc={addCurrencyDesc} />
        )}
      />
      <Stack.Screen
        name="Country"
        children={(props) => (
          <Country {...props} countries={countries} addCountry={addCountry} addCurrencyDesc={addCurrencyDesc} />
        )}
      />
    </Stack.Navigator>
  );
...
export default class App extends Component {
  ...
  addCurrencyDesc = (currency, country) => {
          ...
          <Tab.Screen
            ...
            children={(props) => (
              <CountriesStackScreen
                ...
                addCurrencyDesc={this.addCurrencyDesc}
              />
            )}
          />
          <Tab.Screen
